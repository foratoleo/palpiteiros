...
> Fonte: https://docs.polymarket.com/developers/market-makers/liquidity-rewards
...
2. Calculate first market side score. Assume a trader has the following open orders:
   ...
   $Q_{ne} = (\frac{(3-1)}{3})^2 \cdot 100 + (\frac{(3-2)}{3})^2 \cdot 200 + (\frac{(3-1)}{3})^2 \cdot 100$
...
3. Calculate second market side score. Assume a trader has the following open orders:
   ...
   $Q_{no} = (\frac{(3-1.5)}{3})^2 \cdot 100 + (\frac{(3-2)}{3})^2 \cdot 100 + (\frac{(3-.5)}{3})^2 \cdot 200$
